...
Pour information, la version 2.77 est la dernière qui fonctionne avec le firmware customisé (à la date de la rédaction de cet article), toute version ultérieur à la 2.77 ne fonctionneront pas car HP à supprimé certaines fonctionnalités de contrôle des ventilateurs utilisés par le firmware custom.
...
## Recommandations
Comme mentionné sur l'issue https://github.com/kendallgoto/ilo4_unlock/issues/22, après un redémarrage, nous perdons l'affichage des commandes, mais elles restent fonctionnelles
