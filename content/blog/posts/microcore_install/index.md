...
> [!NOTE]
> Le nom du paquet IPv6 à installer peut varier en fonction de votre version, pour le trouver : http://tinycorelinux.net/16.x/
...
Pour plus de détails, je vous recommande le livre expliquant tout le fonctionnement de Tiny Core : [corebook](http://tinycorelinux.net/corebook.pdf) 
